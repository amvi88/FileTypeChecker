...
namespace FileTypeChecker
{
    ...
    public class FileTypeChecker : IFileTypeChecker
    {
        ...
        private static readonly IList<FileType> DefaultList = new List<FileType>
        {
        ...
        {
            this.knownFileTypes = DefaultList;
        }

        public FileTypeChecker(IList<FileType> knownFileTypes)
        {
            this.knownFileTypes = knownFileTypes.Any() ? knownFileTypes : DefaultList;
        }
